...
from simple_orchestrator_webapi.logging_config import get_internal_logger
...
class OrchestratorDB:
    ...
    def connect(self) -> None:
        """No-op: engine is created in __init__. Kept for API compatibility in tests."""
    ...
    # Compatibility aliases (kept for tests and older call sites)
