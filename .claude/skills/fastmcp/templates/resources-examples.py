...
def get_config() -> dict:
    ...
    return {
        ...
        "limits": {"max_requests": 1000, "max_results": 100},
    }
...
def server_info() -> dict:
    ...
    return {
        ...
        "version": "1.0.0",
        "capabilities": ["static_resources", "dynamic_resources", "resource_templates"],
    }
...
async def get_team_members(org_id: str, team_id: str) -> List[dict]:
    ...
    return [
        {"id": 1, "name": "Alice", "role": "engineer", "org_id": org_id, "team_id": team_id},
        {"id": 2, "name": "Bob", "role": "designer", "org_id": org_id, "team_id": team_id},
    ]
...
async def get_versioned_config(version: str) -> dict:
    ...
    configs = {
        "v1": {"api_version": "v1", "endpoints": ["/users", "/posts"], "deprecated": True},
        "v2": {
            "api_version": "v2",
...
def list_categories() -> List[str]:
    ...
    return ["Technology", "Science", "Business", "Entertainment", "Sports"]
