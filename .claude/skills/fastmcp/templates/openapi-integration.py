...
def load_openapi_spec():
    ...
    try:
        ...
        try:
            ...
            print(
                "Error: OpenAPI spec not found. Please provide OPENAPI_SPEC_URL or openapi.json file"
            )
            return None
...
route_maps = [
    ...
    RouteMap(pattern=r"/(health|healthz|readiness|liveness)", mcp_type=MCPType.EXCLUDE),
]
...
if spec:
    mcp = FastMCP.from_openapi(
        openapi_spec=spec, client=client, name="API Integration Server", route_maps=route_maps
    )
